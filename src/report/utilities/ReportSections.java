...
package report.utilities;

import com.lowagie.text.*;
import com.lowagie.text.pdf.PdfPTable;
import ij.ImagePlus;
import setup.metroloJDialog;
...
public class ReportSections {
    ...
    public Image logoRTMFM(){
        Image logo = null;
        try {
            //logo = Image.getInstance(getClass().getResource("/src/resources/logo_RT-MFM.gif")); //Previous logo
            logo = Image.getInstance(getClass().getResource("/src/resources/2024logo_RT-MFM.gif"));
    ...
    public Paragraph bigTitle(String title){
        ...
        reportTitle.add(new Chunk(title+metroloJDialog.VERSION, new Font(Font.TIMES_ROMAN, 18, Font.BOLD)));
