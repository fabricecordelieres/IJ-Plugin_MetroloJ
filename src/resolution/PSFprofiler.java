...
import utilities.findMax;
import utilities.tricks.dataTricks;
...
public class PSFprofiler {
    ...
    public Plot getXplot(){
        Plot plot=new Plot("Profile plot along the x axis", "x ("+cal.getUnit()+")", "Intensity (AU)");
        plot.add("line", xProfile[0], xProfile[2]);
    ...
    public Plot getYplot(){
        Plot plot=new Plot("Profile plot along the y axis", "y ("+cal.getUnit()+")", "Intensity (AU)");
        plot.add("line", yProfile[0], yProfile[2]);
        plot.setSize(300, 200);
        plot.setColor(Color.red);
    ...
    public Plot getZplot(){
        Plot plot=new Plot("Profile plot along the z axis", "z ("+cal.getUnit()+")", "Intensity (AU)");
        plot.add("line", zProfile[0], zProfile[2]);
        plot.setSize(300, 200);
        plot.setColor(Color.red);
