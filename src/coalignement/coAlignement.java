...
import setup.microscope;
import utilities.findCentre;
import utilities.sideViewGenerator;
...
public class coAlignement {
    ...
    /**
     * This is the original of the reference distance computation (2008). It includes an error and has been replaced by the "calcRefDist" function in 2024
     * @param coordA
     * @param coordB
     * @param micro
     * @return
     */
	private double calcRefDistFromVersion1(double[] coordA, double[] coordB, microscope micro){
    ...
    /**
     * This new formula has been introduced in 2024 after a bug was found by the QUAREP-LiMi network. John Oreopoulos (Oxford Instrument) made the point the previous form of the equation was wrong.
     * @param coordA
     * @param coordB
     * @param micro
     * @return
