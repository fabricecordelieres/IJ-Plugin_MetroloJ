...
import utilities.tricks.fileTricks;
import utilities.tricks.imageTricks;
...
public class fieldIllumination {
    ...
    public ImagePlus getProfilesImage(){
        ...
        Plot plot= new Plot("Field illumination profiles", "Distance to image center", "Intensity");
        plot.add("line", diag_TL_BR[0], diag_TL_BR[1]);
